...
function process_pinqr(){
	...
	$sqlp =  "SELECT * FROM `$db_name`.`admin` WHERE `admin`.`dni` = '$_GET[pin]' ";
				...
				<tr>
					<td colspan=2  valign='middle'  align='right'>
						<form name='cancel' action='indexcam.php' >
									<input type='submit'  value='CERRAR / SALIR' />
						</form>
...
function tcl(){
	...
	$vname = "clp_".$_SESSION['usuarios']."_".date('Y');
	$vname = "`".$vname."`";
